    ...
    private void initClick() {
        ...
        tvCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bitmap = EncodingHandler.createQRCode(Constant.URL_PREFIX + entity.getPositionCode(), 143, 143, null);
                if (bitmap != null) {
        ...
        BaseDialog.getInstance()
                ...
                .setOnClickListener(tv_save, new BaseDialog.OnClickListener() {
                    ...
                    public void onClick(View view, Dialog dialog) {
                        dialog.dismiss();
                        BitmapUtil.saveBitmapInFile(AuditDetailAdminActivity.this, bitmap, "BarCode");
                    }
                })
