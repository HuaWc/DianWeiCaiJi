...
public class CommonDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public com.hwc.dwcj.view.dialog.CommonDialog create() {
            final com.hwc.dwcj.view.dialog.CommonDialog dialog = new com.hwc.dwcj.view.dialog.CommonDialog(P.mContext, mTheme);
