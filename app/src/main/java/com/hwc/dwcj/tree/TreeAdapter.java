...
public class TreeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.addpoints = (TextView) convertView.findViewById(R.id.addpoints);
...
//        holder.icon.setPadding(0, holder.icon.getPaddingTop(), 0, holder.icon.getPaddingBottom());
...
/*            dtEventforselect.latitude = treePoint.getLatitude();
            dtEventforselect.longitude = treePoint.getLongitude();
            dtEventforselect.id = treePoint.getCameraid();
            EventBus.getDefault().post(dtEventforselect);//发送取消*/
        } else {  //如果点击的是父类
