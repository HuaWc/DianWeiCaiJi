...
public class AppConfig {
     ...
     * 获取版本信息
     */
    public static final String checkVersion = mainUrl + "v1/operation/checkVersion";

    /**
     * 获取附件地址
     */
    public static final String getDownloadAccessory = mainUrl + "v1/operation/getDownloadAccessory";
