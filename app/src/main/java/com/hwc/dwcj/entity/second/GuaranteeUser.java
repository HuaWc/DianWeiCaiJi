...
public class GuaranteeUser {
    ...
    public String getSryPeopleIds() {
        return sryPeopleIds;
    }

    public void setSryPeopleIds(String sryPeopleIds) {
        this.sryPeopleIds = sryPeopleIds;
    }

    public String getSryContent() {
        return sryContent;
    }

    public void setSryContent(String sryContent) {
