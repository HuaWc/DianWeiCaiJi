    ...
    public boolean onMarkerClick(Marker arg0) {
       ...
       Cluster cluster= (Cluster) arg0.getObject();
        if(cluster!=null){
            ...
            Log.d(TAG, "onMarkerClick: 1111111111112"+cluster.getCenterLatLng());
            Log.d(TAG, "onMarkerClick: 1111111111112"+cluster.getClusterItems().size());
            Log.d(TAG, "onMarkerClick: 1111111111112"+cluster.getMarker().getId());
            return true;
        }
        return false;
    }
